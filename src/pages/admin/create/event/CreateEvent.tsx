...
const CreateEvent: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const eventData = {
        ...
        location,
        isLocationFlexible: isAvailableForSchools,
      };
      ...
      setToastMessage(error instanceof Error ? error.message : 'Erro ao criar evento. Tente novamente.');
      setIsError(true);
      setShowToast(true);
    }
  };
  ...
  return (
    <IonPage>
      <IonHeader>
        <IonToolbar>
          <IonTitle>Criar Evento</IonTitle>
        </IonToolbar>
      </IonHeader>
